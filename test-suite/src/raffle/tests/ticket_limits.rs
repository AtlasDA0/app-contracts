...
mod tests {
    ...
    pub fn proper_instantiate_raffles_with_limits(max: u32) -> (StargazeApp, Addr, Addr) {
    ...
    #[test]
    fn min_ticket_number_enforced() {
        // create testing app
        let (mut app, raffle_contract_addr, factory_addr) =
            proper_instantiate_raffles_with_limits(80);
            ...
            .execute_contract(
                ...
                &ExecuteMsg::CreateRaffle {
                    ...
                    raffle_options: RaffleOptionsMsg {
                        ...
                        raffle_preview: None,
                        min_ticket_number: Some(min_raffle),
                    },
        ...
        // assert that not enough tickets were bought for the raffle to be finished
        let res: raffles::msg::RaffleResponse = app
            .wrap()
            .query_wasm_smart(
                raffle_contract_addr.clone(),
            ...
            .unwrap();
        assert_eq!(res.clone().raffle_state, RaffleState::Started);
        ...
        let _good_ticket_purchase = app
            .execute_contract(
                ...
                &ExecuteMsg::BuyTicket {
                    raffle_id: 0,
                    ticket_count: min_raffle - 1,
                    sent_assets: AssetInfo::Coin(Coin::new(
                        (min_raffle - 1) as u128 * 100,
                        "ustars".to_string(),
                    )),
                },
                &[Coin::new(
    ...
    fn can_init() {
        // create testing app
        let (mut app, raffle_contract_addr, factory_addr) =
            proper_instantiate_raffles_with_limits(3);
